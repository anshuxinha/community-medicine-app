...
## Corpus Check
- 157 files · ~1,416,816 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 971 nodes · 1437 edges · 113 communities (95 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `717cbfea`
...
Cohesion: 0.07
Nodes (41): resolveBookmarkContentKey(), styles, buildReadingParams(), excerptStyles, findFirstMatchingItemOrSub(), getExcerptAroundMatch(), SearchExcerpt(), SECTION_ID_ICON_MAP (+33 more)
...
Cohesion: 0.15
Nodes (13): AppContext, DashboardScreen(), styles, GemsScreen(), styles, LibraryScreen(), PYQCreateScreen(), styles (+5 more)
...
Cohesion: 0.22
Nodes (12): call_ollama(), _extract_candidate_text(), _extract_json_payload(), fetch_health_updates(), generate_gemini_image(), generate_openai_image(), Fetches real updates from the Government of India PIB feed for MoHFW., Fetches real updates from the Government of India PIB feed for MoHFW. (+4 more)
...
Cohesion: 0.21
Nodes (7): REFERENCE_VALUES, styles, styles, disableScreenCaptureProtection(), enableScreenCaptureProtection(), setScreenCaptureBypass(), subscribeToScreenCaptureChange()
...
Cohesion: 0.23
Nodes (6): AppProvider(), normalizeBookmarks(), sanitizeCloudState(), sanitizeReadItemVersions(), getEffectiveReadCount(), generateReferralCode()
...
Cohesion: 0.25
Nodes (5): styles, EDUCATION_OPTIONS, OCCUPATION_OPTIONS, styles, theme
...
## Knowledge Gaps
- **347 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+342 more)
...
- **Why does `theme` connect `Community 36` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 26`, `Community 27`, `Community 31`, `Community 35`, `Community 37`, `Community 43`, `Community 56`, `Community 71`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Community 10` to `Community 0`, `Community 1`, `Community 35`, `Community 4`, `Community 7`, `Community 71`, `Community 9`, `Community 19`, `Community 25`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `ErrorBoundary` connect `Community 72` to `Community 20`?**
