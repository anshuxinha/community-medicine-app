# Graph Report - The App  (2026-05-26)

## Corpus Check
- 127 files · ~940,902 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 839 nodes · 1256 edges · 90 communities (75 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5aaaf01`
...
6. `enableScreenCaptureProtection()` - 13 edges
7. `disableScreenCaptureProtection()` - 13 edges
...
Cohesion: 0.09
Nodes (34): styles, playerHtml(), styles, VideosScreen(), { width }, addVideoSubscriptionListener(), emitVideoSubscriptionChange(), emitWebinarSubscriptionChange() (+26 more)
...
Cohesion: 0.1
Nodes (22): resolveBookmarkContentKey(), styles, buildReadingParams(), excerptStyles, findFirstMatchingItemOrSub(), getExcerptAroundMatch(), SearchExcerpt(), SECTION_ID_ICON_MAP (+14 more)
...
Cohesion: 0.11
Nodes (16): BASE_MENU_ITEMS, styles, { width }, app, auth, db, firebaseConfig, AppContext (+8 more)
...
Cohesion: 0.1
Nodes (7): ErrorBoundary, CATEGORIES, MUSEUM_ITEMS, BMI_CATEGORIES_ASIAN, styles, KNOWN_HEADERS, styles

### Community 11 - "Community 11"
Cohesion: 0.13
Nodes (19): applyOverrideToTheory(), buildSections(), cloneDeep(), CONTENT_ENTRIES_BY_TITLE, CONTENT_ENTRY_BY_KEY, findItemById(), getCurrentContentItem(), getReadTitles() (+11 more)
...
## Knowledge Gaps
- **303 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+298 more)
...
- **Why does `theme` connect `Community 6` to `Community 32`, `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 20`, `Community 23`, `Community 26`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Community 4` to `Community 32`, `Community 0`, `Community 2`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 20`, `Community 26`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `db` connect `Community 4` to `Community 0`, `Community 6`, `Community 8`, `Community 12`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
