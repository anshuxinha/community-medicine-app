...
## Corpus Check
- 120 files · ~762,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 723 nodes · 855 edges · 151 communities (103 shown, 48 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5ac572e`
...
Cohesion: 0.05
Nodes (39): getCacheKey(), loadAnnotations(), saveAnnotations(), resolveBookmarkContentKey(), applyOverrideToTheory(), buildSections(), cloneDeep(), findItemById() (+31 more)
...
Cohesion: 0.05
Nodes (8): AppNavigator(), AppNavigator(), navigationRef, Stack, Tab, useSessionEnforcer(), playerHtml(), VideosScreen()
...
Cohesion: 0.07
Nodes (21): AppProvider(), normalizeBookmarks(), sanitizeCloudState(), sanitizeReadItemVersions(), getEffectiveReadCount(), DashboardScreen(), getExcerptAroundMatch(), LibraryScreen() (+13 more)
...
## Knowledge Gaps
- **139 isolated node(s):** `Extract text from Ollama /api/chat response shape.`, `Fetches real updates from the Government of India PIB feed for MoHFW.`, `Extracts text from a PDF file.     This is a placeholder function. In a real ap`, `admin`, `fs` (+134 more)
...
- **Why does `toDate()` connect `Community 12` to `Community 8`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `parseFirestoreDate()` connect `Community 8` to `Community 12`?**
