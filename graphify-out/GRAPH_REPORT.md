# Graph Report - The App  (2026-07-29)

## Corpus Check
- 201 files · ~1,493,437 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1310 nodes · 2046 edges · 150 communities (133 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0e9e6629`
...
1. `useThemedStyles()` - 88 edges
2. `theme` - 39 edges
3. `AppContext` - 23 edges
4. `db` - 17 edges
5. `getContentKey()` - 17 edges
6. `useResponsive()` - 15 edges
7. `useAppTheme()` - 15 edges
8. `generate_review_bundle()` - 14 edges
9. `getContentSignature()` - 14 edges
10. `enableScreenCaptureProtection()` - 14 edges
...
- `DropdownPicker()` --calls--> `useThemedStyles()`  [EXTRACTED]
  src/components/DropdownPicker.js → src/styles/useThemedStyles.js

## Communities (150 total, 17 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (39): crypto, signUrl(), admin, db, FREE_VIDEO_TITLES, hostname, { onCall, HttpsError }, { setGlobalOptions } (+31 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (29): buildTableCellSet(), clamp(), getBlockAnchorText(), isExamMarkupLine(), isNtruHsHeading(), isNtruHsMetaLine(), normalizeAnchorText(), parseMarkdown() (+21 more)
...
Cohesion: 0.11
Nodes (18): BookmarksScreen(), styles, DietarySurveyScreen(), REFERENCE_VALUES, styles, LoginScreen(), styles, QuizScreen() (+10 more)

### Community 5 - "Community 5"
Cohesion: 0.1
Nodes (21): CATEGORIES, MUSEUM_ITEMS, SearchScreen(), StatusMark(), styles, TYPE_ICON, CONTENT_SECTIONS, buildGemsIndex() (+13 more)
...
Cohesion: 0.12
Nodes (20): AppProvider(), collectLearningStateCandidates(), dayDiffFromToday(), mergeBookmarksLists(), mergeDailyReadHistory(), mergeLearningStates(), mergeReadItemVersions(), normalizeBookmarks() (+12 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (20): app, buildBunnyEmbedUrl(), EmptyState(), FreeLabel(), pdfViewerHtml(), playerHtml(), styles, VideosLoadErrorState() (+12 more)

### Community 9 - "Community 9"
Cohesion: 0.13
Nodes (24): versions, applyOverrideToTheory(), buildSections(), cloneDeep(), CONTENT_ENTRIES_BY_TITLE, CONTENT_ENTRY_BY_KEY, findItemById(), getActiveOverrides() (+16 more)
...
Cohesion: 0.14
Nodes (14): formatSpeedLabel(), formatTime(), GestureVideoPlayer(), SPEED_OPTIONS, styles, useEventListenerSafe(), PYQ_IMAGES, PYQPracticeScreen() (+6 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (12): ReferralAnnouncementDialog(), styles, AppContext, GemsScreen(), styles, PYQCreateScreen(), styles, MONTH_NAMES (+4 more)

### Community 16 - "Community 16"
Cohesion: 0.14
Nodes (11): ChapterCompleteSheet(), appIcon, styles, UpdateDetailDialog(), UPDATES_IMAGES, DashboardScreen(), styles, UpdateDownloadIndicator() (+3 more)
...
Cohesion: 0.18
Nodes (12): appColors, darkColors, getAppColors(), getNavigationTheme(), getPaperTheme(), paperTheme, normalizePreference(), resolveScheme() (+4 more)

### Community 22 - "Community 22"
Cohesion: 0.19
Nodes (15): resolveBookmarkContentKey(), buildReadingParams(), buildReadingParamsFromEntry(), ReadingScreen(), buildReadingParams(), buildReadingParams(), StatusMark(), styles (+7 more)
...
Cohesion: 0.17
Nodes (11): BASE_MENU_ITEMS, DrawerMenu(), styles, { width }, auth, db, firebaseConfig, AdminAppFeedbackScreen() (+3 more)
...
Cohesion: 0.2
Nodes (11): useUnlockOrientationOnFocus(), excerptStyles, findFirstMatchingItemOrSub(), FreeLabel(), getExcerptAroundMatch(), getExcerptStyles(), LibraryScreen(), SearchExcerpt() (+3 more)
...
Cohesion: 0.25
Nodes (6): ThemeModePill(), TabNavigator(), APPEARANCE_OPTIONS, ProfileScreen(), styles, useAppTheme()
...
Cohesion: 0.25
Nodes (3): ErrorBoundary, styles, lightColors
...
Cohesion: 0.5
Nodes (4): buildVideoSupportMailto(), getVideoLoadErrorInfo(), mapVideoLoadError(), VIDEO_LOAD_ERROR_CATALOG
...
## Knowledge Gaps
- **429 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+424 more)
...
- **Why does `useThemedStyles()` connect `Community 4` to `Community 1`, `Community 5`, `Community 8`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 22`, `Community 24`, `Community 28`, `Community 29`, `Community 32`, `Community 40`, `Community 41`, `Community 46`, `Community 56`, `Community 61`, `Community 75`, `Community 98`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `theme` connect `Community 4` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 22`, `Community 24`, `Community 28`, `Community 29`, `Community 32`, `Community 40`, `Community 41`, `Community 46`, `Community 56`, `Community 57`, `Community 61`, `Community 75`, `Community 98`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `next` connect `Community 99` to `Community 9`?**
