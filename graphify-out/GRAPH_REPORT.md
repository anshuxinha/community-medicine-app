...
## Corpus Check
- 125 files · ~992,446 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1408 nodes · 1988 edges · 178 communities (118 shown, 60 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 55 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d4e7d63`
...
- `App()` --calls--> `ensureFirebaseApp()`  [INFERRED]
  App.js → scripts/sync-reading-illustrations.js
...
## Communities (178 total, 60 thin omitted)
...
Cohesion: 0.07
Nodes (45): AppProvider(), resolveBookmarkContentKey(), applyOverrideToTheory(), buildSections(), cloneDeep(), findItemById(), getContentKey(), getContentSignature() (+37 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (42): App(), buildThumbnailUrl(), bunnyFetch(), discoverPullZoneHostname(), ensureFirebaseApp(), getExpoPushTokens(), main(), markNotified() (+34 more)
...
Cohesion: 0.08
Nodes (15): BASE_MENU_ITEMS, styles, { width }, flex1, { height: WINDOW_HEIGHT }, styles, appIcon, styles (+7 more)
...
Cohesion: 0.1
Nodes (14): resolveBookmarkContentKey(), ReadingScreen(), styles, buildReadingParams(), styles, buildReadingParams(), styles, TOPIC_ID_ICON_MAP (+6 more)
...
Cohesion: 0.11
Nodes (9): styles, REFERENCE_VALUES, styles, styles, styles, disableScreenCaptureProtection(), enableScreenCaptureProtection(), setScreenCaptureBypass() (+1 more)
...
Cohesion: 0.15
Nodes (16): admin, ensureFirebaseApp(), fs, loadSeed(), LOCAL_IMAGE_DIR, main(), parseArgs(), path (+8 more)
...
Cohesion: 0.18
Nodes (9): AppNavigator(), AppContext, useSessionEnforcer(), AppNavigator(), navigationRef, Stack, Tab, setupNotificationTapHandler() (+1 more)
...
Cohesion: 0.25
Nodes (8): getCacheKey(), loadHighlights(), saveHighlights(), getCacheKey(), loadHighlights(), saveHighlights(), subscribeHighlights(), syncAllHighlights()
...
## Knowledge Gaps
- **436 isolated node(s):** `{ createCanvas }`, `fs`, `path`, `{ getDefaultConfig }`, `config` (+431 more)
...
- **Why does `App()` connect `Community 2` to `Community 19`, `Community 13`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `theme` connect `Community 13` to `Community 3`, `Community 37`, `Community 6`, `Community 38`, `Community 8`, `Community 41`, `Community 11`, `Community 43`, `Community 14`, `Community 17`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 30`?**
