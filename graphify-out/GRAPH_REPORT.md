...
## Corpus Check
- 257 files · ~1,656,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1656 nodes · 2735 edges · 183 communities (164 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea192ace`
...
Cohesion: 0.07
Nodes (33): CHAPTER_NMC_MAP, getChapterNmcMeta(), getChaptersForPaper(), getPaperMeta(), getPrimaryPaperForChapterId(), LEARNER_ROLES, NMC_PAPERS, PRACTICAL_SKILL_MAP (+25 more)
...
Cohesion: 0.11
Nodes (16): ChapterCompleteSheet(), REVIEW_CTA_VARIANTS, ReferralAnnouncementDialog(), styles, useUpdatesFeed(), DashboardScreen(), styles, UpdateDownloadIndicator() (+8 more)

### Community 12 - "Community 12"
Cohesion: 0.1
Nodes (18): DropdownPicker(), styles, CATEGORIES, MUSEUM_ITEMS, PYQCreateScreen(), styles, EDUCATION_OPTIONS, OCCUPATION_OPTIONS (+10 more)
...
Cohesion: 0.15
Nodes (15): ThemeModePill(), APPEARANCE_OPTIONS, ProfileScreen(), styles, getAppColors(), getNavigationTheme(), getPaperTheme(), paperTheme (+7 more)
...
Cohesion: 0.12
Nodes (11): DietarySurveyScreen(), REFERENCE_VALUES, styles, LoginScreen(), styles, QuizScreen(), styles, disableScreenCaptureProtection() (+3 more)
...
Cohesion: 0.19
Nodes (16): BookmarksScreen(), styles, buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParams(), StatusMark() (+8 more)
...
Cohesion: 0.14
Nodes (17): entry, item, key, leaf, mutatedItem, silentEntry, silentItem, staleVersions (+9 more)
...
Cohesion: 0.18
Nodes (9): useUnlockOrientationOnFocus(), ReadingScreen(), styles, buildSpeechChunks(), buildSpeechText(), cleanSpeechText(), collectSpeechFragments(), OBJECT_KEYS_TO_SKIP (+1 more)
...
Cohesion: 0.2
Nodes (12): excerptStyles, findFirstMatchingItemOrSub(), findFirstMatchingLeaf(), FreeLabel(), getExcerptAroundMatch(), getExcerptStyles(), itemMatchesQuery(), SearchExcerpt() (+4 more)
...
Cohesion: 0.29
Nodes (5): BASE_MENU_ITEMS, DrawerMenu(), styles, { width }, auth
...
## Knowledge Gaps
- **510 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+505 more)
...
- **Why does `list` connect `Community 4` to `Community 16`, `Community 3`, `Community 5`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `useThemedStyles()` connect `Community 12` to `Community 0`, `Community 2`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 27`, `Community 32`, `Community 36`, `Community 37`, `Community 42`, `Community 47`, `Community 57`, `Community 67`?**
