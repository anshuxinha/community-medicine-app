# Graph Report - The App  (2026-08-26)

## Corpus Check
- 281 files · ~1,781,135 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1743 nodes · 2863 edges · 207 communities (186 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20766af1`
...
## Communities (207 total, 21 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (55): app, buildBunnyEmbedUrl(), EmptyState(), FreeLabel(), pdfViewerHtml(), playerHtml(), styles, VideosLoadErrorState() (+47 more)
...
Cohesion: 0.08
Nodes (26): DEFAULT_TOPIC_ILLUSTRATION_MAP, CATEGORIES, MUSEUM_ITEMS, HighlightedExcerpt(), SearchScreen(), StatusMark(), styles, TYPE_ICON (+18 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (26): AppProvider(), collectLearningStateCandidates(), dayDiffFromToday(), extractPremiumFromCustomerInfo(), getPremiumTypeFromEntitlement(), hasRevenueCatPremiumEntitlement(), mergeBookmarksLists(), mergeDailyReadHistory() (+18 more)
...
Cohesion: 0.1
Nodes (18): BASE_MENU_ITEMS, DrawerMenu(), styles, { width }, ReviewFeedbackModal(), ReviewRequestModal(), VideoRequestModal(), auth (+10 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (19): ReferralAnnouncementDialog(), styles, useUpdatesFeed(), DashboardScreen(), GemsScreen(), styles, LibraryScreen(), OnboardingScreen() (+11 more)
...
Cohesion: 0.16
Nodes (22): resolveBookmarkContentKey(), buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParamsFromEntry(), ReadingScreen(), buildReadingParams(), buildReadingParams(), StatusMark() (+14 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (12): styles, AnthropometryScreen(), BMI_CATEGORIES_ASIAN, styles, FieldToolboxScreen(), styles, NotificationsScreen(), styles (+4 more)
...
Cohesion: 0.13
Nodes (12): flex1, { height: WINDOW_HEIGHT }, styles, UpdateBottomSheet(), db, firebaseConfig, LoginScreen(), styles (+4 more)
...
Cohesion: 0.16
Nodes (14): useUnlockOrientationOnFocus(), excerptStyles, findFirstMatchingItemOrSub(), findFirstMatchingLeaf(), FreeLabel(), getExcerptAroundMatch(), getExcerptStyles(), itemMatchesQuery() (+6 more)
...
Cohesion: 0.18
Nodes (10): entry, item, key, leaf, mutatedItem, silentEntry, silentItem, staleVersions (+2 more)
...
## Knowledge Gaps
- **530 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+525 more)
...
- **Why does `list` connect `Community 1` to `Community 3`, `Community 5`, `Community 14`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `useThemedStyles()` connect `Community 11` to `Community 0`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 32`, `Community 37`, `Community 40`, `Community 46`, `Community 57`, `Community 84`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `generate_review_bundle()` connect `Community 3` to `Community 1`?**
