...
## Corpus Check
- 123 files · ~764,790 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1364 nodes · 1939 edges · 175 communities (115 shown, 60 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 55 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ddce1089`
...
## Communities (175 total, 60 thin omitted)
...
Cohesion: 0.05
Nodes (58): AppProvider(), resolveBookmarkContentKey(), applyOverrideToTheory(), buildSections(), cloneDeep(), findItemById(), getContentKey(), getContentSignature() (+50 more)
...
Cohesion: 0.07
Nodes (15): styles, ErrorBoundary, styles, flex1, { height: WINDOW_HEIGHT }, styles, appIcon, styles (+7 more)
...
Cohesion: 0.11
Nodes (11): BASE_MENU_ITEMS, styles, { width }, app, auth, db, firebaseConfig, AppContext (+3 more)
...
Cohesion: 0.12
Nodes (19): emitWebinarSubscriptionChange(), ensureNotificationHandler(), getTodayNotificationKey(), isSubscribedToVideoNotifications(), markStreakMilestoneSentToday(), requestPermissions(), scheduleAllNotifications(), sendVideoNotification() (+11 more)
...
Cohesion: 0.13
Nodes (17): getCacheKey(), loadAnnotations(), saveAnnotations(), getCacheKey(), loadHighlights(), saveHighlights(), styles, getCacheKey() (+9 more)
...
Cohesion: 0.13
Nodes (7): styles, REFERENCE_VALUES, styles, styles, disableScreenCaptureProtection(), enableScreenCaptureProtection(), subscribeToScreenCaptureChange()
...
Cohesion: 0.15
Nodes (10): normalizeBookmarks(), sanitizeCloudState(), sanitizeReadItemVersions(), AppProvider(), normalizeBookmarks(), sanitizeCloudState(), sanitizeReadItemVersions(), getEffectiveReadCount() (+2 more)
...
Cohesion: 0.39
Nodes (8): getDefaultDeviceName(), getDeviceId(), getDeviceInfo(), isFirstDeviceLogin(), getDefaultDeviceName(), getDeviceId(), getDeviceInfo(), isFirstDeviceLogin()
...
- **Why does `App()` connect `Community 15` to `Community 4`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `ensureFirebaseApp()` connect `Community 15` to `Community 2`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `theme` connect `Community 4` to `Community 1`, `Community 34`, `Community 3`, `Community 35`, `Community 6`, `Community 39`, `Community 41`, `Community 10`, `Community 12`, `Community 16`, `Community 17`, `Community 52`, `Community 21`, `Community 24`, `Community 27`, `Community 30`?**
