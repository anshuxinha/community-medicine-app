# Graph Report - The App  (2026-06-13)

## Corpus Check
- 136 files · ~963,661 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 921 nodes · 1374 edges · 107 communities (87 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be914801`
...
- `UpdatesScreen()` --calls--> `useResponsive()`  [EXTRACTED]
  src/screens/UpdatesScreen.js → src/styles/theme.js
...
Cohesion: 0.07
Nodes (38): styles, getPdfViewerUrl(), pdfViewerHtml(), playerHtml(), styles, VideosScreen(), { width }, addVideoSubscriptionListener() (+30 more)
...
Cohesion: 0.14
Nodes (19): applyOverrideToTheory(), buildSections(), cloneDeep(), CONTENT_ENTRIES_BY_TITLE, CONTENT_ENTRY_BY_KEY, findItemById(), getCurrentContentEntry(), getCurrentContentItem() (+11 more)
...
Cohesion: 0.18
Nodes (9): styles, REFERENCE_VALUES, styles, styles, theme, disableScreenCaptureProtection(), enableScreenCaptureProtection(), setScreenCaptureBypass() (+1 more)
...
Cohesion: 0.23
Nodes (11): buildReadingParams(), ReadingScreen(), styles, buildReadingParams(), buildReadingParams(), styles, TOPIC_ID_ICON_MAP, getContentKey() (+3 more)

### Community 14 - "Community 14"
Cohesion: 0.17
Nodes (10): BASE_MENU_ITEMS, styles, { width }, app, auth, db, firebaseConfig, useSessionEnforcer() (+2 more)
...
Cohesion: 0.19
Nodes (9): AppProvider(), normalizeBookmarks(), resolveBookmarkContentKey(), sanitizeCloudState(), sanitizeReadItemVersions(), getEffectiveReadCount(), getReadTitles(), VALID_CONTENT_KEYS (+1 more)
...
Cohesion: 0.18
Nodes (7): styles, DashboardScreen(), styles, GemsScreen(), styles, LibraryScreen(), useResponsive()
...
Cohesion: 0.24
Nodes (5): AppContext, CATEGORIES, MUSEUM_ITEMS, KNOWN_HEADERS, styles
...
Cohesion: 0.22
Nodes (4): navigationRef, Stack, Tab, styles
...
## Knowledge Gaps
- **336 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+331 more)
...
- **Why does `theme` connect `Community 11` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 13`, `Community 14`, `Community 17`, `Community 21`, `Community 22`, `Community 25`, `Community 28`, `Community 30`, `Community 35`, `Community 36`, `Community 37`, `Community 42`, `Community 56`, `Community 59`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `db` connect `Community 14` to `Community 0`, `Community 34`, `Community 4`, `Community 5`, `Community 13`, `Community 17`, `Community 22`, `Community 57`, `Community 58`, `Community 59`, `Community 28`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Community 30` to `Community 0`, `Community 35`, `Community 36`, `Community 37`, `Community 5`, `Community 11`, `Community 13`, `Community 14`, `Community 17`, `Community 21`, `Community 56`, `Community 59`, `Community 28`?**
