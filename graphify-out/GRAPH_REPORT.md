...
## Corpus Check
- 130 files · ~943,174 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 867 nodes · 1290 edges · 94 communities (77 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `71b711c4`
...
Cohesion: 0.06
Nodes (35): flex1, { height: WINDOW_HEIGHT }, styles, app, db, firebaseConfig, STATUS_TONES, styles (+27 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (33): styles, buildReadingParams(), ReadingScreen(), styles, buildReadingParams(), styles, buildReadingParams(), styles (+25 more)
...
Cohesion: 0.1
Nodes (26): styles, addVideoSubscriptionListener(), emitVideoSubscriptionChange(), emitWebinarSubscriptionChange(), ensureNotificationHandler(), getTodayNotificationKey(), isSubscribedToVideoNotifications(), markStreakMilestoneSentToday() (+18 more)
...
Cohesion: 0.11
Nodes (12): AppContext, REFERENCE_VALUES, styles, styles, PLAN_METADATA, styles, styles, styles (+4 more)
...
Cohesion: 0.21
Nodes (8): AppProvider(), normalizeBookmarks(), resolveBookmarkContentKey(), sanitizeCloudState(), sanitizeReadItemVersions(), getEffectiveReadCount(), VALID_CONTENT_KEYS, VALID_MASTER_TITLES
...
## Knowledge Gaps
- **315 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+310 more)
...
- **Why does `theme` connect `Community 5` to `Community 0`, `Community 1`, `Community 34`, `Community 4`, `Community 6`, `Community 8`, `Community 15`, `Community 21`, `Community 22`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Community 6` to `Community 0`, `Community 1`, `Community 5`, `Community 14`, `Community 15`, `Community 22`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `db` connect `Community 0` to `Community 4`, `Community 5`, `Community 6`, `Community 14`, `Community 22`, `Community 30`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
