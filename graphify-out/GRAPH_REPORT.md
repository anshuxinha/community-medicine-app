# Graph Report - The App  (2026-08-13)

## Corpus Check
- 221 files · ~1,513,391 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1519 nodes · 2477 edges · 153 communities (136 shown, 17 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02c48524`
...
1. `useThemedStyles()` - 94 edges
2. `theme` - 39 edges
3. `AppContext` - 26 edges
4. `fetch_health_updates()` - 20 edges
5. `useResponsive()` - 19 edges
6. `getContentKey()` - 19 edges
7. `db` - 18 edges
8. `getContentSignature()` - 18 edges
9. `generate_review_bundle()` - 16 edges
...
Cohesion: 0.06
Nodes (41): ChapterCompleteSheet(), REVIEW_CTA_VARIANTS, CHAPTER_NMC_MAP, getChapterNmcMeta(), getChaptersForPaper(), getPaperMeta(), getPrimaryPaperForChapterId(), LEARNER_ROLES (+33 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (45): crypto, signUrl(), admin, ADMIN_EMAILS, db, FREE_VIDEO_TITLES, functionsV1, hostname (+37 more)
...
Cohesion: 0.07
Nodes (25): DropdownPicker(), styles, ThemeModePill(), flex1, { height: WINDOW_HEIGHT }, styles, UpdateBottomSheet(), BookmarksScreen() (+17 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (33): versions, entry, item, key, leaf, silentEntry, silentItem, staleVersions (+25 more)
...
Cohesion: 0.1
Nodes (18): BASE_MENU_ITEMS, DrawerMenu(), styles, { width }, auth, db, firebaseConfig, AdminAppFeedbackScreen() (+10 more)
...
Cohesion: 0.12
Nodes (16): buildTableCellSet(), clamp(), getBlockAnchorText(), isExamMarkupLine(), isNtruHsHeading(), isNtruHsMetaLine(), normalizeAnchorText(), parseMarkdown() (+8 more)
...
Cohesion: 0.18
Nodes (9): AppContext, styles, APPEARANCE_OPTIONS, styles, styles, disableScreenCaptureProtection(), enableScreenCaptureProtection(), setScreenCaptureBypass() (+1 more)

### Community 26 - "Community 26"
Cohesion: 0.22
Nodes (14): ensureReviewPromptMigrated(), getHasRatedFiveStarReview(), markAsRated(), markAsShown(), markVideoPrompted(), maybePromptReview(), maybePromptReviewAfterVideo(), openStoreReviewPage() (+6 more)
...
Cohesion: 0.24
Nodes (13): buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParamsFromEntry(), ReadingScreen(), buildReadingParams(), buildReadingParams(), styles, TOPIC_ID_ICON_MAP (+5 more)
...
Cohesion: 0.33
Nodes (4): ReviewFeedbackModal(), ALL_ORIENTATIONS, submitAppFeedback(), registerOpenFeedbackForm()
...
## Knowledge Gaps
- **489 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+484 more)
...
- **Why does `list` connect `Community 4` to `Community 1`, `Community 3`, `Community 13`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `useThemedStyles()` connect `Community 5` to `Community 0`, `Community 1`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 25`, `Community 28`, `Community 29`, `Community 30`, `Community 33`, `Community 36`, `Community 50`, `Community 51`, `Community 66`, `Community 67`?**
