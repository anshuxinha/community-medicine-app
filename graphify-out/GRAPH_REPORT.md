...
## Corpus Check
- 253 files · ~1,656,314 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1630 nodes · 2644 edges · 178 communities (159 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `114af814`
...
Cohesion: 0.05
Nodes (48): ReviewFeedbackModal(), VideoRequestModal(), ALL_ORIENTATIONS, DEFAULT_TOPIC_ILLUSTRATION_MAP, AdminAppFeedbackScreen(), formatWhen(), getSortValue(), STATUS_TONES (+40 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (57): app, db, firebaseConfig, NotificationsScreen(), styles, buildBunnyEmbedUrl(), EmptyState(), FreeLabel() (+49 more)
...
Cohesion: 0.11
Nodes (20): SearchScreen(), StatusMark(), styles, TYPE_ICON, isVideoFree(), subscribeToVideos(), buildGemsIndex(), buildLibraryIndex() (+12 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (13): styles, flex1, { height: WINDOW_HEIGHT }, styles, UpdateBottomSheet(), AnthropometryScreen(), BMI_CATEGORIES_ASIAN, styles (+5 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (13): BookmarksScreen(), styles, DietarySurveyScreen(), REFERENCE_VALUES, styles, LoginScreen(), styles, QuizScreen() (+5 more)
...
Cohesion: 0.12
Nodes (15): ReferralAnnouncementDialog(), styles, AppContext, useUpdatesFeed(), DashboardScreen(), GemsScreen(), styles, PYQCreateScreen() (+7 more)
...
Cohesion: 0.14
Nodes (17): getPaperMeta(), useUnlockOrientationOnFocus(), LearningProgressScreen(), excerptStyles, findFirstMatchingItemOrSub(), findFirstMatchingLeaf(), FreeLabel(), getExcerptAroundMatch() (+9 more)
...
Cohesion: 0.13
Nodes (14): CATEGORIES, MUSEUM_ITEMS, FieldToolboxScreen(), styles, buildSupportMailto(), FAQ_ITEMS, getDeviceOsLabel(), SupportScreen() (+6 more)
...
Cohesion: 0.14
Nodes (12): ChapterCompleteSheet(), REVIEW_CTA_VARIANTS, BASE_MENU_ITEMS, DrawerMenu(), styles, { width }, auth, styles (+4 more)
...
Cohesion: 0.2
Nodes (9): entry, item, key, leaf, silentEntry, silentItem, staleVersions, updated (+1 more)
...
- **Why does `list` connect `Community 5` to `Community 4`, `Community 21`, `Community 14`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `useThemedStyles()` connect `Community 20` to `Community 0`, `Community 1`, `Community 2`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 37`, `Community 51`, `Community 67`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `generate_review_bundle()` connect `Community 4` to `Community 5`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
