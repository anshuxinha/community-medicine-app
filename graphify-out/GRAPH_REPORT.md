...
## Corpus Check
- 255 files · ~1,657,006 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1644 nodes · 2697 edges · 182 communities (163 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f93627a7`
...
Cohesion: 0.05
Nodes (49): collectLearningStateCandidates(), dayDiffFromToday(), extractPremiumFromCustomerInfo(), getPremiumTypeFromEntitlement(), hasRevenueCatPremiumEntitlement(), mergeBookmarksLists(), mergeDailyReadHistory(), mergeLearningStates() (+41 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (44): CHAPTER_NMC_MAP, getChapterNmcMeta(), getChaptersForPaper(), getPaperMeta(), getPrimaryPaperForChapterId(), LEARNER_ROLES, NMC_PAPERS, PRACTICAL_SKILL_MAP (+36 more)
...
Cohesion: 0.08
Nodes (36): ReviewFeedbackModal(), ReviewRequestModal(), VideoRequestModal(), ALL_ORIENTATIONS, AdminAppFeedbackScreen(), formatWhen(), getSortValue(), STATUS_TONES (+28 more)
...
Cohesion: 0.1
Nodes (22): buildTableCellSet(), clamp(), getBlockAnchorText(), isExamMarkupLine(), isNtruHsHeading(), isNtruHsMetaLine(), normalizeAnchorText(), parseMarkdown() (+14 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (17): BookmarksScreen(), styles, DietarySurveyScreen(), REFERENCE_VALUES, styles, LoginScreen(), styles, QuizScreen() (+9 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (19): DropdownPicker(), styles, ThemeModePill(), flex1, { height: WINDOW_HEIGHT }, styles, UpdateBottomSheet(), FieldToolboxScreen() (+11 more)
...
Cohesion: 0.13
Nodes (20): applyOverrideToTheory(), buildSections(), cloneDeep(), CONTENT_ENTRIES_BY_TITLE, CONTENT_ENTRY_BY_KEY, findItemById(), getActiveOverrides(), getCurrentContentEntry() (+12 more)
...
Cohesion: 0.13
Nodes (13): ChapterCompleteSheet(), REVIEW_CTA_VARIANTS, BASE_MENU_ITEMS, DrawerMenu(), styles, { width }, auth, styles (+5 more)

### Community 22 - "Community 22"
Cohesion: 0.16
Nodes (12): useUnlockOrientationOnFocus(), styles, getCacheKey(), loadAnnotations(), saveAnnotations(), subscribeAnnotations(), syncAllAnnotations(), getCacheKey() (+4 more)
...
Cohesion: 0.17
Nodes (14): app, db, firebaseConfig, buildOpenHlsUrl(), formatDuration(), formatPublishedDate(), FREE_VIDEO_TITLES, getTimestamp() (+6 more)
...
Cohesion: 0.15
Nodes (12): AppProvider(), entry, item, key, leaf, silentEntry, silentItem, staleVersions (+4 more)
...
Cohesion: 0.32
Nodes (12): resolveBookmarkContentKey(), buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParamsFromEntry(), ReadingScreen(), buildReadingParams(), buildReadingParams(), getContentKey() (+4 more)
...
Cohesion: 0.24
Nodes (9): find_node(), main(), next, versions, getLeafEntryIndex(), getNextLeafEntry(), getNextUnreadLeafEntry(), isEntryReadForProgress() (+1 more)
...
## Knowledge Gaps
- **509 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+504 more)
...
- **Why does `list` connect `Community 3` to `Community 1`, `Community 5`, `Community 14`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `useThemedStyles()` connect `Community 9` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 29`, `Community 36`, `Community 43`, `Community 44`, `Community 48`, `Community 58`, `Community 71`?**
