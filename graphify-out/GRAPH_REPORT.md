# Graph Report - The App  (2026-08-18)

## Corpus Check
- 258 files · ~1,657,273 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1664 nodes · 2753 edges · 182 communities (164 shown, 18 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f2c231b0`
...
4. `getContentKey()` - 21 edges
5. `fetch_health_updates()` - 20 edges
...
Cohesion: 0.06
Nodes (47): DEFAULT_TOPIC_ILLUSTRATION_MAP, useUnlockOrientationOnFocus(), ReadingScreen(), styles, getCacheKey(), loadAnnotations(), saveAnnotations(), subscribeAnnotations() (+39 more)
...
Cohesion: 0.08
Nodes (33): buildTableCellSet(), clamp(), getBlockAnchorText(), isExamMarkupLine(), isNtruHsHeading(), isNtruHsMetaLine(), normalizeAnchorText(), parseMarkdown() (+25 more)
...
Cohesion: 0.09
Nodes (25): collectLearningStateCandidates(), dayDiffFromToday(), extractPremiumFromCustomerInfo(), getPremiumTypeFromEntitlement(), hasRevenueCatPremiumEntitlement(), mergeBookmarksLists(), mergeDailyReadHistory(), mergeLearningStates() (+17 more)
...
Cohesion: 0.09
Nodes (24): ReferralAnnouncementDialog(), ReviewRequestModal(), AppContext, useUpdatesFeed(), DashboardScreen(), GemsScreen(), styles, PYQCreateScreen() (+16 more)
...
Cohesion: 0.09
Nodes (25): buildBunnyEmbedUrl(), EmptyState(), FreeLabel(), pdfViewerHtml(), playerHtml(), styles, VideosLoadErrorState(), VideosScreen() (+17 more)
...
Cohesion: 0.06
Nodes (3): navigationRef, Stack, Tab
...
Cohesion: 0.1
Nodes (15): DropdownPicker(), styles, styles, DietarySurveyScreen(), REFERENCE_VALUES, styles, FieldToolboxScreen(), styles (+7 more)
...
Cohesion: 0.15
Nodes (12): ReviewFeedbackModal(), VideoRequestModal(), ALL_ORIENTATIONS, AdminAppFeedbackScreen(), formatWhen(), getSortValue(), STATUS_TONES, buildVideoRequestMessage() (+4 more)
...
Cohesion: 0.15
Nodes (16): LearningProgressScreen(), excerptStyles, findFirstMatchingItemOrSub(), findFirstMatchingLeaf(), FreeLabel(), getExcerptAroundMatch(), getExcerptStyles(), itemMatchesQuery() (+8 more)
...
Cohesion: 0.27
Nodes (16): resolveBookmarkContentKey(), buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParams(), buildLibraryReadingParams(), getCachedSignatureForItem() (+8 more)
...
Cohesion: 0.22
Nodes (6): LoginScreen(), styles, getDefaultDeviceName(), getDeviceId(), getDeviceInfo(), isFirstDeviceLogin()

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (12): AppProvider(), entry, item, key, leaf, mutatedItem, silentEntry, silentItem (+4 more)
...
Cohesion: 0.24
Nodes (9): ThemeModePill(), useSessionEnforcer(), AppNavigator(), TabNavigator(), ProfileScreen(), getAppColors(), getNavigationTheme(), getPaperTheme() (+1 more)

### Community 49 - "Community 49"
Cohesion: 0.25
Nodes (7): paperTheme, normalizePreference(), resolveScheme(), safeSystemScheme(), ThemeContext, ThemeProvider(), ThemedApp()
...
## Knowledge Gaps
- **511 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+506 more)
...
- **Why does `list` connect `Community 4` to `Community 2`, `Community 19`, `Community 5`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `useThemedStyles()` connect `Community 8` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 22`, `Community 23`, `Community 33`, `Community 36`, `Community 37`, `Community 38`, `Community 48`, `Community 65`, `Community 71`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `generate_review_bundle()` connect `Community 2` to `Community 4`?**
