# Graph Report - The App  (2026-05-17)

## Corpus Check
- 123 files · ~765,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1365 nodes · 1946 edges · 181 communities (122 shown, 59 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 55 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2b231db`
...
6. `db` - 14 edges
7. `generate_review_bundle()` - 14 edges
...
Cohesion: 0.1
Nodes (40): buildThumbnailUrl(), bunnyFetch(), discoverPullZoneHostname(), getExpoPushTokens(), main(), markNotified(), parseArgs(), parseFirestoreDate() (+32 more)
...
Cohesion: 0.1
Nodes (10): styles, styles, styles, styles, EDUCATION_OPTIONS, OCCUPATION_OPTIONS, styles, appColors (+2 more)
...
Cohesion: 0.16
Nodes (14): AppContext, DashboardScreen(), LibraryScreen(), DashboardScreen(), GemsScreen(), styles, LibraryScreen(), MONTH_NAMES (+6 more)
...
Cohesion: 0.18
Nodes (7): buildReadingParams(), styles, buildReadingParams(), CONTENT_SECTIONS, getContentSignature(), getUpdatedSegmentsForItem(), hashString()

### Community 28 - "Community 28"
Cohesion: 0.15
Nodes (7): resolveBookmarkContentKey(), styles, TOPIC_ID_ICON_MAP, getContentKey(), getCurrentContentEntry(), getCurrentContentItem(), getLeafContentRefsForItem()

### Community 29 - "Community 29"
Cohesion: 0.15
Nodes (7): BASE_MENU_ITEMS, styles, { width }, appIcon, styles, auth, styles
...
Cohesion: 0.23
Nodes (9): getCacheKey(), loadHighlights(), saveHighlights(), styles, getCacheKey(), loadHighlights(), saveHighlights(), subscribeHighlights() (+1 more)
...
Cohesion: 0.18
Nodes (7): flex1, { height: WINDOW_HEIGHT }, styles, app, db, firebaseConfig, styles
...
Cohesion: 0.22
Nodes (10): emitVideoSubscriptionChange(), ensureNotificationHandler(), isSubscribedToVideoNotifications(), persistVideoNotificationPreference(), requestPermissions(), scheduleAllNotifications(), sendVideoNotification(), sendWebinarNotification() (+2 more)
...
Cohesion: 0.67
Nodes (4): getItemStatus(), getReadVersionForItem(), isItemPendingUpdate(), isItemReadCurrent()
...
- **Why does `App()` connect `Community 13` to `Community 5`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `ensureFirebaseApp()` connect `Community 13` to `Community 2`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `theme` connect `Community 5` to `Community 1`, `Community 10`, `Community 14`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 40`, `Community 41`, `Community 58`?**
