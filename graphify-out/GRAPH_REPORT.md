...
## Corpus Check
- 127 files · ~942,524 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 867 nodes · 1292 edges · 94 communities (75 shown, 19 thin omitted)
...
Cohesion: 0.08
Nodes (28): flex1, { height: WINDOW_HEIGHT }, styles, app, db, firebaseConfig, DEFAULT_TOPIC_ILLUSTRATION_MAP, styles (+20 more)
