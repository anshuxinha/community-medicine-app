...
## Corpus Check
- 255 files · ~1,656,962 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1643 nodes · 2696 edges · 185 communities (166 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4b2c067d`
...
Cohesion: 0.06
Nodes (40): ChapterCompleteSheet(), REVIEW_CTA_VARIANTS, CHAPTER_NMC_MAP, getChapterNmcMeta(), getChaptersForPaper(), getPaperMeta(), LEARNER_ROLES, NMC_PAPERS (+32 more)
...
Cohesion: 0.06
Nodes (43): scan_all(), _all_links_from_months(), _build_months_map(), call_ollama(), _extract_candidate_text(), _extract_json_payload(), fetch_health_updates(), generate_gemini_image() (+35 more)
...
Cohesion: 0.09
Nodes (23): CATEGORIES, MUSEUM_ITEMS, SearchScreen(), StatusMark(), styles, TYPE_ICON, isVideoFree(), subscribeToVideos() (+15 more)
...
Cohesion: 0.13
Nodes (19): styles, TabNavigator(), APPEARANCE_OPTIONS, ProfileScreen(), styles, appColors, darkColors, getAppColors() (+11 more)
...
Cohesion: 0.1
Nodes (18): appIcon, styles, UpdateDetailDialog(), UPDATES_IMAGES, BookmarksScreen(), FieldToolboxScreen(), styles, FreeLabel() (+10 more)
...
Cohesion: 0.14
Nodes (24): resolveBookmarkContentKey(), buildReadingParamsFromEntry(), buildReadingParams(), buildReadingParamsFromEntry(), ReadingScreen(), buildReadingParams(), buildReadingParams(), entry (+16 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (14): BASE_MENU_ITEMS, DrawerMenu(), styles, { width }, app, auth, db, firebaseConfig (+6 more)
...
Cohesion: 0.15
Nodes (19): AppProvider(), collectLearningStateCandidates(), dayDiffFromToday(), extractPremiumFromCustomerInfo(), getPremiumTypeFromEntitlement(), hasRevenueCatPremiumEntitlement(), mergeBookmarksLists(), mergeDailyReadHistory() (+11 more)
...
Cohesion: 0.15
Nodes (11): AppContext, styles, styles, styles, TOPIC_ID_ICON_MAP, theme, getLeafContentRefsForItem(), disableScreenCaptureProtection() (+3 more)
...
Cohesion: 0.12
Nodes (10): DropdownPicker(), styles, ThemeModePill(), DietarySurveyScreen(), REFERENCE_VALUES, styles, EDUCATION_OPTIONS, OCCUPATION_OPTIONS (+2 more)
...
Cohesion: 0.2
Nodes (12): getPrimaryPaperForChapterId(), useUnlockOrientationOnFocus(), excerptStyles, findFirstMatchingItemOrSub(), findFirstMatchingLeaf(), getExcerptAroundMatch(), getExcerptStyles(), itemMatchesQuery() (+4 more)
...
Cohesion: 0.27
Nodes (9): buildOpenHlsUrl(), formatDuration(), formatPublishedDate(), FREE_VIDEO_TITLES, getTimestamp(), getVideoCategories(), resolvePlaybackSource(), toDate() (+1 more)
...
- **Why does `list` connect `Community 4` to `Community 0`, `Community 3`, `Community 13`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `useThemedStyles()` connect `Community 14` to `Community 0`, `Community 2`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 16`, `Community 17`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 30`, `Community 35`, `Community 36`, `Community 39`, `Community 48`, `Community 54`, `Community 67`, `Community 85`, `Community 86`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `generate_review_bundle()` connect `Community 3` to `Community 4`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
