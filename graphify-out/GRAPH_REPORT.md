...
## Corpus Check
- 157 files · ~1,416,795 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 969 nodes · 1434 edges · 113 communities (96 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9337823d`
...
Cohesion: 0.07
Nodes (40): resolveBookmarkContentKey(), buildReadingParams(), excerptStyles, findFirstMatchingItemOrSub(), getExcerptAroundMatch(), SearchExcerpt(), SECTION_ID_ICON_MAP, styles (+32 more)
...
Cohesion: 0.1
Nodes (13): styles, styles, styles, flex1, { height: WINDOW_HEIGHT }, styles, styles, EDUCATION_OPTIONS (+5 more)
...
Cohesion: 0.14
Nodes (14): AppContext, PYQ_IMAGES, GemsScreen(), styles, LibraryScreen(), PYQCreateScreen(), styles, PYQPracticeScreen() (+6 more)
...
Cohesion: 0.16
Nodes (10): BASE_MENU_ITEMS, styles, { width }, app, auth, db, firebaseConfig, DashboardScreen() (+2 more)
...
Cohesion: 0.17
Nodes (8): styles, REFERENCE_VALUES, styles, styles, disableScreenCaptureProtection(), enableScreenCaptureProtection(), setScreenCaptureBypass(), subscribeToScreenCaptureChange()
...
Cohesion: 0.26
Nodes (10): call_ollama(), _extract_candidate_text(), _extract_json_payload(), fetch_health_updates(), generate_openai_image(), Fetches real updates from the Government of India PIB feed for MoHFW., Fetches real updates from the Government of India PIB feed for MoHFW., Extract text from Ollama /api/chat response shape. (+2 more)
...
## Knowledge Gaps
- **346 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+341 more)
...
- **Why does `theme` connect `Community 4` to `Community 0`, `Community 1`, `Community 26`, `Community 36`, `Community 37`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 17`, `Community 20`, `Community 22`, `Community 57`, `Community 58`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Community 9` to `Community 0`, `Community 1`, `Community 36`, `Community 37`, `Community 7`, `Community 12`, `Community 14`, `Community 17`, `Community 58`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `ErrorBoundary` connect `Community 22` to `Community 4`?**
