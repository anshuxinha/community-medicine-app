# Graph Report - The App  (2026-06-02)

## Corpus Check
- 133 files · ~960,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 904 nodes · 1351 edges · 96 communities (80 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4529b578`
...
Cohesion: 0.05
Nodes (25): styles, ErrorBoundary, styles, flex1, { height: WINDOW_HEIGHT }, styles, appIcon, styles (+17 more)
...
Cohesion: 0.11
Nodes (20): resolveBookmarkContentKey(), buildReadingParams(), excerptStyles, findFirstMatchingItemOrSub(), getExcerptAroundMatch(), SearchExcerpt(), SECTION_ID_ICON_MAP, styles (+12 more)
...
Cohesion: 0.16
Nodes (10): styles, REFERENCE_VALUES, styles, styles, styles, theme, disableScreenCaptureProtection(), enableScreenCaptureProtection() (+2 more)
...
Cohesion: 0.13
Nodes (10): BASE_MENU_ITEMS, styles, { width }, app, auth, firebaseConfig, AppContext, STATUS_TONES (+2 more)

### Community 11 - "Community 11"
Cohesion: 0.16
Nodes (17): applyOverrideToTheory(), buildSections(), cloneDeep(), CONTENT_ENTRIES_BY_TITLE, CONTENT_ENTRY_BY_KEY, findItemById(), getCurrentContentEntry(), getCurrentContentItem() (+9 more)
...
Cohesion: 0.14
Nodes (9): CATEGORIES, MUSEUM_ITEMS, useSessionEnforcer(), AppNavigator(), navigationRef, Stack, Tab, KNOWN_HEADERS (+1 more)
...
Cohesion: 0.23
Nodes (12): db, styles, getCacheKey(), loadAnnotations(), saveAnnotations(), subscribeAnnotations(), syncAllAnnotations(), getCacheKey() (+4 more)
...
Cohesion: 0.21
Nodes (8): AppProvider(), normalizeBookmarks(), sanitizeCloudState(), sanitizeReadItemVersions(), getEffectiveReadCount(), getReadTitles(), VALID_CONTENT_KEYS, VALID_MASTER_TITLES
...
## Knowledge Gaps
- **329 isolated node(s):** `admin`, `path`, `SERVICE_ACCOUNT_PATH`, `admin`, `path` (+324 more)
...
- **Why does `theme` connect `Community 8` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 13`, `Community 14`, `Community 18`, `Community 22`, `Community 25`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `db` connect `Community 18` to `Community 0`, `Community 1`, `Community 34`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 25`, `Community 26`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `AppContext` connect `Community 10` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 9`, `Community 13`, `Community 18`, `Community 25`, `Community 26`?**
