# -*- coding: utf-8 -*-
"""Publish overhauled leaves for chapters 31 and 32 to Firestore."""
import json
import os
...
def main():
    ...
    print(f"Publishing {len(LEAF_IDS)} leaves for Chapters 31 & 32 to Firestore libraryContentOverrides...")
    success = 0
    for leaf_id in LEAF_IDS:
        ...
        payload = {
            ...
            "markAsNew": False,
            "updatedSegments": [],
            "sourceUpdates": [{"title": "publish_ch31_ch32_overrides.py", "type": "manual_override"}],
            "approvedAt": now_iso,
            "approvedBy": "grok-cli",
            "updatedAt": now_iso,
            "publishedAt": now_iso,
