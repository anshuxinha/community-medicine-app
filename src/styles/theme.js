...
/**
 * Light palette — values match pre-dark-mode product look.
 * Prefer these semantic tokens over raw hex in UI code.
 */
export const lightColors = {
  ...
  // Inverse (branded dark header bands on light app)
 ...
 * Surfaces step up slightly for elevation; brand purple preserved.
 */
export const darkColors = {
  ...
  // Keep branded dark header chrome stable
...
// Legacy static export — always light. Prefer useAppTheme() for scheme-aware UI.
export const theme = {
  colors: lightColors,
};
