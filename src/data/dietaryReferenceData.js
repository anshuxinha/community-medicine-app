...
export const FOOD_SEARCH_ALIASES = {
  ...
  barley: ["jau", "barley"],
  maize_dry: ["makka", "makki", "corn", "maize"],
  rice_brown: ["brown rice"],
  wheat_whole: ["whole wheat grain", "gehu"],
  vermicelli: ["seviyan", "sewai", "semiya"],
  horse_gram: ["kulthi", "kulith", "horsegram"],
  cowpea: ["lobia", "chawli", "black eyed pea"],
  peas_dry: ["dried peas", "sukha matar"],
  urad_whole: ["sabut urad", "whole urad"],
  bathua: ["chenopodium", "bathua saag"],
  colocasia_leaves: ["arbi patta", "taro leaves"],
  basella: ["poi", "pui", "malabar spinach"],
  karela: ["bitter gourd", "bitter melon"],
  capsicum_green: ["shimla mirch", "bell pepper", "capsicum"],
  cluster_beans: ["gawar", "gowar", "guar"],
  ash_gourd: ["petha", "winter melon", "white gourd"],
  ridge_gourd: ["turai", "dodka", "tori"],
  drumstick_pods: ["sahjan", "moringa pod", "drumstick"],
  pumpkin: ["kaddu", "kaddoo"],
  snake_gourd: ["chichinda", "padwal"],
  french_beans: ["beans", "faras bean"],
  tinda: ["indian round gourd"],
  arbi: ["colocasia", "taro", "arvi"],
  radish_white: ["mooli", "muli"],
  beetroot: ["chukandar", "beet"],
  tapioca: ["kappa", "cassava", "maravalli"],
  grapes: ["angoor"],
  pomegranate: ["anar", "anaar"],
  watermelon: ["tarbooj", "tarbuj"],
  dates_dry: ["khajoor", "khajur"],
  custard_apple: ["sitaphal", "sharifa"],
  jackfruit: ["kathal", "chakka"],
  pineapple: ["ananas"],
  sapota: ["chikoo", "chiku", "sapodilla"],
  musk_melon: ["kharbooja", "kharbooz"],
  mosambi: ["sweet lime", "mausambi"],
  khoa: ["mawa", "khoya"],
  groundnut_oil: ["peanut oil", "moongphali oil"],
  sunflower_oil: ["surajmukhi oil"],
  coconut_oil: ["nariyal oil"],
  vanaspati: ["dalda", "hydrogenated fat"],
  chicken_liver: ["murgi kaleji"],
  goat_liver: ["kaleji", "mutton liver"],
  fish_catla: ["catla", "machli"],
  prawns_small: ["jhinga", "shrimp"],
  egg_yolk: ["yolk", "anda pili"],
  cashew: ["kaju"],
  coconut_fresh: ["nariyal", "fresh coconut"],
  coconut_dry: ["copra", "sukha nariyal"],
  walnut: ["akhrot"],
  pistachio: ["pista"],
  coconut_water: ["nariyal pani"],
  snack_khichdi: ["khichdi", "khichri", "kitchari"],
};
